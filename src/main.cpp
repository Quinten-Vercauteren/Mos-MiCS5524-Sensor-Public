#include <Arduino.h>
#include <WiFiS3.h>
#include <bestSecrets.h>
#include <Wire.h>

#define GAS_SENSORPIN A1
...
void sendDataSheets()
{
  ...
  String gas = String(analogRead(GAS_SENSORPIN));
  Serial.print(GAS_SENSORPIN + "PPM");

  // Construct the final URL for the Google Sheets script
  String urlFinal = GOOGLE_APPS_SCRIPT_URL + GOOGLE_SCRIPT_ID + "/exec?gas=" + gas;
